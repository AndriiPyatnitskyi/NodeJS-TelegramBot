...
accountRouter.post('/api/accounts', validator(accountSchema), permit([ Role.USER, Role.ADMIN]), controller.createAccount);
accountRouter.put('/api/accounts/:id', validator(accountSchema), permit([ Role.USER, Role.ADMIN]), controller.updateAccount);
